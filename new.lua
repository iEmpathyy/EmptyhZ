...
cFire.newLabel("------------- Clicking Tools (Only works for PC maybe) -------------") -- Creates the folder(U will put here your buttons,etc)
    
    task.wait(0.1)
    cFire.newLabel("------------- 55X and 65.5Y is Default Offsets -------------")

    local autoclicklim = 0
    cFire.newSlider("AutoClick Speed...", "Default 0 & Max. 5", 5, false, function(value)
        autoclicklim = value
    end)
    
    local limoffsetX = 55
    cFire.newSlider("AutoClick Offset X", "Min. -200 & Max. 200", 200, false, function(value)
        limoffsetX = value
    end)
    local limoffsetY = 65.5
    cFire.newSlider("AutoClick Offset Y", "Min. -200 & Max. 200", 200, false, function(value)
        limoffsetY = value
    end)
    local MaxPrice = 1
    cFire.newSlider("Max Price (1 Default)", "Min. 1 & Max. 10000, use default (1)", 10000, false, function(value)
        MaxPrice = value
    end)
    
    cFire.newToggle("Auto Clicker Buy Limited", "Auto Click Limited (OP)", false, function(bool1)
    ...
    cFire.newToggle("Auto Clicker Buy (0 ONLY)", "Auto click buy 0 price maybe.", false, function(bool2)
    ...
    cFire.newToggle("Auto Close Error Clicker", "Auto close error", false, function(bool2)
    ...
    plyrHub.newLabel("Normal") -- Creates the folder(U will put here your buttons,etc)
