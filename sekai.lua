...
cFire:newLabel("Clicking Tools (Only works for PC maybe)") -- Creates the folder(U will put here your buttons,etc)
    ...
    local limoffsetX = 55
    cFire.newSlider("AutoClick Offset X", "Min. -200 & Max. 200", {
    ...
    cFire.newSlider("AutoClick Offset Y", "Min. -200 & Max. 200", {
        min = -200, -- min value of the slider
        max = 200, -- max value of the slider
        precise = true -- max 2 decimals
    }, function(value)
    ...
    local MaxPrice = 1
    cFire.newSlider("Max Price (1 Default)", "Min. 1 & Max. 10000, use default (1)", {
